#Iterators
Iterators are extremely important for Ruby. Please go through each of these functions through Rubys
official documentation and build a single ruby file where you go through each of the following Ruby
functions. This will be listed in one of the assignments below.
